    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-[var(--color-border-light)]">
          {/* "Your cart" italic bold -- real site jaisa */}
              ...
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 items-start">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="border border-[var(--color-border-light)] rounded p-1 hover:bg-[var(--color-surface)]"
                  ...
                  <button
                    ...
                    className="bg-primary text-white rounded-full p-1.5 hover:bg-orange-600 transition"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
